...
|---------|------|------|-------|------|---------|------|
| TSK-A08 | done | - | - | - | xxx.md | ✅ d99368e |
| TSK-A19 | ready | A08 | - | - | xxx.md | - |
| TSK-A20 | paused | A08 | - | - | xxx.md | - |
| TSK-A21 | needs-contract | - | SubmitTaskProgress 未分配角色白名单 | auto | - | - |
| TSK-A13 | needs-contract | - | OKR Web 前端首页 | manual | - | - |
```
